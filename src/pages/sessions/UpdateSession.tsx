...
export default function UpdateSession() {
  ...
  const [form, setForm] = useState<UpdateSessionRequest>({
    title: loaderData.title,
    start: loaderData.start,
    duration: loaderData.duration,
    tags: loaderData.tags,
    meetingLink: loaderData.meetingLink,
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-400 to-purple-500 py-10 px-4">
      <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-2xl overflow-hidden">
        <div className="bg-gradient-to-r from-indigo-600 to-purple-700 text-white text-center p-10">
          <h1 className="text-3xl font-semibold mb-2">Update Session</h1>
          <p className="opacity-90 text-lg">Edit the session details below</p>
        </div>
